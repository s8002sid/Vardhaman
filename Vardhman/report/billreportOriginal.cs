...
namespace Vardhman.report {
    ...
    public class billreportOriginal : ReportClass {
        
        public billreportOriginal() {
        }
        
        public override string ResourceName {
            get {
                return "billreportOriginal.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedbillreportOriginal : Component, ICachedReport {
        
        public CachedbillreportOriginal() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            billreportOriginal rpt = new billreportOriginal();
            rpt.Site = this.Site;
            return rpt;
        }
